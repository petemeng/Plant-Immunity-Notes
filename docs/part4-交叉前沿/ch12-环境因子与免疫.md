...
<span class="authors">Cheng C, Gao X, Feng B, et al.</span>
环境信号与免疫通路耦合的代表性研究。
<span class="journal"><em>Nature</em>, 2011.</span>
</div>
<div class="reading-reason">提供“环境重塑免疫输出”的早期关键证据。</div>
</div>
<div class="reading-item">
<div class="reading-ref">
<span class="authors">Kim Y, et al.</span>
温度等环境因子塑造免疫反应强度的前沿研究。
<span class="journal"><em>Nature</em>, 2022.</span>
</div>
<div class="reading-reason">用于理解气候背景下免疫失衡与脆弱性。</div>
</div>
<div class="reading-item">
<div class="reading-ref">
...
<div class="reading-reason">适合将机制问题外推到田间生态尺度。</div>
</div>
</div>
