...
<p>本章聚焦“PTI 与 ETI 的关系演变”这一核心主题，目标是把分散知识组织成可验证、可复用的科学逻辑链。</p>
...
<h2><span class="section-num">2.3</span>核心机制</h2>
...
<h2><span class="section-num">2.4</span>里程碑研究思路拆解</h2>
...
<h2><span class="section-num">2.5</span>当前争论与未解问题</h2>
...
<h2><span class="section-num">2.6</span>关键实验方法</h2>
<table>
<thead>
...
<a href="#"><div><span class="nav-label">上一章</span>← 第1章 植物免疫全景</div></a>
<a href="#"><div style="text-align:right;"><span class="nav-label">下一章</span>第3章 受体与信号转导 →</div></a>
</nav>
</div>
