<div class="page-wrapper">
  ...
  <div class="breadcrumb"><a href="../../">首页</a><span>›</span><span>第四部分 · 交叉前沿</span><span>›</span>第13章</div>
  ...
  <section class="box box-cognition learning-guide" id="ch13-learning-guide"><div class="box-title">学习目标与阅读路线</div><p><strong>学完本章，你应能：</strong></p><ul><li>区分 miRNA、siRNA 与 lncRNA 的来源和调控层次。</li><li>沿着来源、传递、功能与表型四步评价跨界 RNA 的证据。</li><li>区分个体内预激、子代效应与严格意义的跨代遗传。</li></ul><p><strong>必备概念：</strong>nt 是核苷酸数；AGO 是小 RNA 的功能伙伴；序列互补提出靶标假设；ceRNA 指竞争性内源 RNA，不等同于胞外运输载体。</p><p><strong>阅读路线：</strong>先用13.1—13.2理解小 RNA，再读13.3认识长 RNA 的不同机制。13.4与13.5初读重点是证据边界，结构域和小 RNA 编号可在第二遍补记。</p></section>
  ...
  <p>这个调控层的重要性最初在抗病毒免疫中被认识——RNA 沉默是植物对抗 RNA 病毒的重要防线之一 <span class="cross-ref">→ 第1章 1.1节</span>。但随着研究的深入，ncRNA 的角色已远远超出了抗病毒：<strong>内源 miRNA 通过精确调节免疫受体和信号蛋白的表达水平来微调免疫系统的"灵敏度"，lncRNA 通过影响染色质状态参与免疫记忆的建立，而跨界 RNA 转移更将植物-病原的信息战从蛋白质层面扩展到了 RNA 层面</strong>。</p>
  ...
  <p><strong>过去：</strong>RNA 沉默最初被视为实验室中的基因工具或转座子控制机制，与免疫关系不大。<br><strong>转折：</strong>2000年代初，多项研究证明 RNA 沉默是植物抗病毒免疫的主要机制——许多植物病毒具有 RNA 沉默抑制子（VSR）的观察，从反面证明了沉默路径的防御重要性。<br><strong>现在：</strong>RNA 沉默被认为是与 PTI/ETI 平行的第三大免疫层——尤其对 RNA 病毒，它比 NLR 介导的免疫更为普遍和基础。</p></div>
  ...
  <h3>病毒与 RNA 沉默的相互作用</h3>
  <p>许多植物病毒具有干扰宿主 RNA 沉默的蛋白功能，这反过来支持 RNA 沉默具有防御意义。阅读相关研究时，应区分小 RNA 积累、AGO 活性、局部沉默与系统信号等不同观察层次；一个层次变化并不能自动确定整株抗性的变化。病毒相关蛋白也可能有多重功能，其表型不能仅用单一作用解释。</p>


  <p>RNA 沉默与 NLR 免疫可以在同一个病毒互作体系中共同发挥作用。例如，烟草 N 介导的免疫与病毒复制相关蛋白的感知有关，但不能把所有这样的关系都称为受体“直接结合 VSR”。应分别判断被感知的分子、是否存在中介宿主蛋白以及对最终抗性的贡献。</p>
  ...
  <ul>
    <li><strong>miR393——最早被鉴定的"免疫 miRNA"：</strong>Navarro et al. (2006) 在 <em>Science</em> 上报道，flg22 处理诱导 miR393 的积累，miR393 靶向降解生长素受体 TIR1/AFB 的 mRNA。由于生长素信号促进易感性（这里指宿主生长素响应与抗性结果的联系），miR393 通过抑制生长素信号来间接增强免疫——这是<strong>第一个将 miRNA 与植物免疫直接连接的发现</strong>，也是生长素-免疫拮抗的重要分子机制 <span class="cross-ref">→ 第5章 5.4节</span>。</li>
  ...
  <ol class="mechanism-steps">
    ...
    <li><strong>解除抑制：</strong>在某些体系中，特定 miRNA 的减少可使其靶转录本积累。但这不是全部 miRNA 的统一响应：miR393 在经典 PTI 研究中反而被诱导。最终速度还取决于转录本与蛋白质的周转。</li>
  ...
  <p>miRNA 可改变靶转录本的寿命或翻译，从而调节蛋白质积累。需要注意：被切断的单条 mRNA 不会被“逆转修复”；所谓可逆，是整个系统可通过新的 RNA 合成恢复表达。也不能未经能量测量就断言 miRNA 总比蛋白质调控省资源。转录因子、RNA 调控和蛋白质周转是相互补充的层次。</p>
  ...
  <ul>
    ...
    <li><strong>ALEX1：</strong>在水稻中鉴定的一个 lncRNA，参与 JA 信号通路的调节，影响对白叶枯病的抗性 (Yu et al., 2020；<a href="https://onlinelibrary.wiley.com/doi/10.1111/pbi.13234">原始研究</a>)。</li>
    <li><strong>天然反义转录本（NAT）：</strong>多个免疫相关基因座被发现有反义 lncRNA 的转录。这些 NAT 可以通过 RNA-RNA 互作调节正义链的稳定性或翻译效率，为免疫基因的表达增加了一层精细调控。</li>
  </ul>

  <h3>lncRNA 与免疫记忆</h3>
  <p>某些 lncRNA 可以通过 RNA–蛋白或染色质相关机制影响基因表达，因此它们是否参与免疫预激值得研究。但不能预先将“免疫记忆”认定为所有免疫 lncRNA 的主要功能；个别已验证案例与广泛的相关性筛选应分别讨论。</p>
  <ul>
    ...
    <li>RNA 指导的 DNA 甲基化连接小 RNA 与染色质调控，但检测到 lncRNA 表达和 DNA 甲基化同时改变，尚不能证明该 lncRNA 直接建立了防御记忆。</li>
  </ul>
  ...
  <ul>
    <li>病原的"武器库"不仅包括效应蛋白，还包括小 RNA——后者可以精准、影响宿主防御。</li>
  ...
  <ul>
    ...
    <li><strong>Cai et al. (2018)：</strong>在拟南芥与灰霉菌体系中提出 TET8 相关胞外囊泡参与植物小 RNA 传递的机制。研究连接了胞外组分、RNA 与疾病表型；适用边界是具体植物、真菌和实验背景，不能扩展为所有植物跨界 RNA 都由同一种囊泡运送。</li>
  </ul>

  <p>这些发现开辟了一个全新的应用方向：<strong>宿主诱导基因沉默（Host-Induced Gene Silencing, HIGS）</strong>——在转基因植物中表达靶向病原关键基因的 dsRNA/miRNA，从而研究 RNA 介导的防御作用。HIGS 已在多种病理系统中展示了原理验证，包括抗真菌、抗卵菌和抗线虫 <span class="cross-ref">→ 第14章</span>。</p>

  <p>Liu et al. (2025) 与 Ni et al. (2026) 分别讨论根系 RNA 与微生物互作、水稻 ceRNA 与跨界 RNAi 的联系。这些是具有特定宿主和病害背景的研究案例，不能合并成所有植物均具有的统一“三方 RNA 防御通路”。尤其要区分 ceRNA 在宿主体内的竞争调控与 RNA 真正跨越物种边界的过程。</p>
  ...
  <div class="figure">
    ...
    <p class="figure-caption"><strong>图 13.2 跨界 RNA 转移的双向机制。</strong>病原小 RNA 可以进入植物细胞并劫持宿主 AGO，植物也可通过胞外组分输出小 RNA；宿主体内的 ceRNA 调节也可能影响 RNA 互作结局，并可能重塑有益根际微生物。</p>
  </div>
  ...
  <!-- ======== 13.5 表观遗传学 ======== -->
  <div class="box box-cognition"><div class="box-title">◆ 证据边界：胞外 RNA 不等于囊泡内部 RNA</div><p>Zand Karimi et al. (2022) 在拟南芥质外体发现位于囊泡之外的 RNA–蛋白复合物，提示胞外 RNA 有多种承载形态。它不自动否定特定体系中的囊泡运输，却要求我们在解释跨界 RNAi 时分别检验来源、空间位置、受体细胞内的功能与疾病贡献。混合组织测序或预测到互补序列，均不能单独完成这条证据链。<a href="https://pmc.ncbi.nlm.nih.gov/articles/PMC9048913/">原始研究</a>。</p></div>
  ...
  <ul>
    <li><strong>SWI/SNF 复合物：</strong>其成员通过改变核小体组织影响基因表达，但作用方向随基因座、组织与信号而变。Walley et al. (2008) 研究 SPLAYED 的特定胁迫通路功能，不能支持“SYD 与 BRM 都是免疫负调控因子”这一整体归纳。</li>
    <li><strong>INO80 复合物：</strong>INO80 染色质重塑复合物在 DNA 损伤修复和转录调控中起作用，有证据表明其也参与防御基因的转录调控。INO80 的突变影响 SA 响应基因的表达水平。</li>
    <li><strong>不同重塑因子的差异：</strong>不同 ATP 依赖重塑因子具有不同结构与靶向关系，不应因为都影响核小体就把它们归为同一家族或赋予统一的免疫作用。</li>
  </ul>
  ...
  <ul>
    ...
    <li>Holeski et al. (2012) 是跨代防御与表观遗传遗传的综述；其中讨论的不同物种案例需追溯各自原始论文，不能把综述本身当作一次猴面花实验。</li>
  </ul>
  <p>跨代效应需要排除种子营养、激素、亲代发育状态及种传微生物等替代解释。植物的表观遗传重编程具有位点和细胞类型差异，不能照搬“每代全基因组甲基化被清空”的模型。还应区分直接受亲代环境影响的一代与在无该刺激条件下继续保持的跨代效应。</p>
  ...
  <p>不同 ncRNA 可控制受体数量、激素响应或染色质环境。单个突变的温和表型可能来自冗余，也可能说明其作用受条件限制；没有足够数据时不应给出统一的抗性降幅。评价其必要性，应结合具体分子作用与宿主背景，而不是预设 ncRNA 只做“微调”。</p>
  </div>
  ...
  <tr><td>ChIP-seq 与 ATAC-seq</td><td>解析免疫相关基因座的组蛋白修饰和染色质可及性变化</td><td class="ref">Jaskiewicz et al., 2011, EMBO Rep</td></tr>
  </tbody></table>
...
<div class="reading-item"><div class="reading-ref"><span class="authors">Zhang T, Zhao YL, Zhao JH, et al.</span><span class="title"><em>Cotton plants export microRNAs to inhibit virulence gene expression in a fungal pathogen.</em></span><span class="journal"><em>Nat Plants</em>, 2016.</span></div><div class="reading-reason">跨界 RNA 功能扩展实证。</div></div>
  ...
  <ol class="references">
    ...
    <li>Ni J, Mao W, Shi T, et al. A rice ceRNA module suppresses <em>Rhizoctonia solani</em>-induced cross-kingdom RNAi to reduce fungal pathogenicity. <em>Nat Commun</em>, 2026, 17: 4233. DOI: 10.1038/s41467-026-72158-5.</li>
    ...
    <li>Zand Karimi H, Baldrich P, Rutter BD, et al. Arabidopsis apoplastic fluid contains sRNA- and circular RNA–protein complexes that are located outside extracellular vesicles. <em>Plant Cell</em>, 2022, 34: 1863–1881. DOI: 10.1093/plcell/koac043. <a href="https://pmc.ncbi.nlm.nih.gov/articles/PMC9048913/">开放全文</a>.</li>
  ...
  <section class="learning-review" id="ch13-learning-review"><h2>学习整合：RNA 的存在、运输和功能是三个问题</h2><p>植物与微生物混合样本同时含有双方 RNA 并不令人意外。因此，即使测到微生物来源小 RNA，也不能直接说它已经进入植物细胞，更不能直接说它沉默了宿主基因。证据应按问题分层：</p><ol class="mechanism-steps"><li><strong>来源：</strong>序列能否可靠归属于某一方？同源序列和混合组织污染是否存在其他解释？</li><li><strong>位置与传递：</strong>RNA 位于组织表面、胞外环境还是受体细胞内部？与囊泡一同出现是否真的表示在囊泡内部？</li><li><strong>分子功能：</strong>是否有 AGO 关联、靶标作用或其他机制证据？互补预测不等于实际沉默。</li><li><strong>疾病贡献：</strong>分子变化是否足以解释植物表型？是否还有发育、营养或免疫背景变化等替代解释？</li></ol><p>lncRNA 的因果分析还有一个特别难点：改变它所在的 DNA 区域，可能同时改变邻近基因的调控元件；改变转录，也可能影响染色质而不依赖 RNA 成品本身。因此必须区分<strong>DNA 位点、转录过程与 RNA 分子</strong>的作用。一个基因座相关表型不能自动证明 RNA 成品就是作用者。</p><p>“非编码”不是“没有功能”，也不意味着“只通过一种机制工作”。同样，体内小 RNA 的形成机制与外源 RNA 应用的实际效果不能相互替代：自然界有某种互作，不等于任何环境下都能可靠利用它。</p><h3>理解检查与参考答案</h3><p>先尝试用自己的话回答，再展开解释。</p><details><summary>1. 预测到一条真菌小 RNA 与植物 mRNA 互补，下一步结论能写“跨界沉默”吗？</summary><p><strong>参考答案与解释：</strong>不能。互补是候选关系；还缺真实来源、空间转移、功能装载、靶标效应及表型贡献等证据。</p></details><details><summary>2. 删除一个 lncRNA 基因座后免疫改变，是否证明 RNA 分子有功能？</summary><p><strong>参考答案与解释：</strong>尚不能。删除也可能影响 DNA 调控元件、转录过程或邻近基因，应区分这些解释。</p></details><details><summary>3. 亲代受刺激后子代更抗病，是否已经证明稳定跨代表观遗传？</summary><p><strong>参考答案与解释：</strong>不是。种子营养、激素和微生物等亲代效应都可能贡献；还要判断无持续刺激时是否跨代保持及其具体机制。</p></details><p class="evidence-note">本节概念例子用于训练推理；文中数值若未标注为原始研究数据，不应当作真实实验结果。全章的研究方法介绍用于阅读与证据判断，不构成操作流程。</p></section>

  <nav class="chapter-nav"><a href="../../part4-交叉前沿/ch12-环境因子与免疫/"><div><span class="nav-label">上一章</span>← 第12章 环境因子与免疫</div></a><a href="../../part5-转化与展望/ch14-从基础到抗病育种/"><div style="text-align:right;"><span class="nav-label">下一章</span>第14章 从基础到抗病育种 →</div></a></nav>
</div>
