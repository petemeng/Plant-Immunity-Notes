...
<p class="chapter-subtitle">miRNA、siRNA 与跨界 RNA 的免疫意义</p>
</div>
</header>
...
<p>本章聚焦“非编码 RNA 与免疫调控”这一核心主题，目标是把分散知识组织成可验证、可复用的科学逻辑链。</p>
...
<h2><span class="section-num">13.3</span>核心机制</h2>
...
<h2><span class="section-num">13.4</span>里程碑研究思路拆解</h2>
...
<h2><span class="section-num">13.5</span>当前争论与未解问题</h2>
...
<h2><span class="section-num">13.6</span>关键实验方法</h2>
<table>
<thead>
...
<h2><span class="section-num">13.7</span>推荐阅读</h2>
<div class="reading-level level-essential">
<h4>🔴 必读</h4>
<div class="reading-item">
<div class="reading-ref">本章对应方向的奠基性综述与里程碑研究（建议先读框架文献）。</div>
<div class="reading-reason">用于建立概念边界与核心术语。</div>
</div>
</div>
...
<a href="#"><div><span class="nav-label">上一章</span>← 第12章 环境因子与免疫</div></a>
<a href="#"><div style="text-align:right;"><span class="nav-label">下一章</span>第14章 从基础到抗病育种 →</div></a>
</nav>
</div>
